(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'reaVisualSelect',
        defaults = {
            item             : 'rea-select-item',              // visual select item [class name]
            selected         : 'rea-selected',                 // selected item [class name]
            caption          : 'rea-select-caption',           // caption under visual item [class name]
            container        : 'rea-visual-select',            // select items container [class name]
