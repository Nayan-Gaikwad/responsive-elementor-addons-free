...
var _isArray = _interopRequireDefault(__webpack_require__(125));
  ...
  $(document).on("rea_ajax_select2_init", function (event, obj) {
    ...
    setTimeout(function () {
      var IDSelect2 = $(ID).select2({
        ...
        ajax: {
          url: rea_ajax_select2_localize.ajaxurl + "?action=rea_ajax_select2_search_post&post_type=" + obj.data.source_type + "&source_name=" + obj.data.source_name,
          dataType: "json"
        },
        initSelection: function initSelection(element, callback) {
          if (!obj.multiple) {
            callback({
              id: "",
              text: rea_ajax_select2_localize.search_text
            });
          } else {
            callback({
              id: "",
          ...
          if (!(0, _isArray.default)(obj.currentID) && "" != obj.currentID) {
            ids = [obj.currentID];
          } else if ((0, _isArray.default)(obj.currentID)) {
          ...
          if (ids.length > 0) {
            ...
            $.ajax({
              method: "POST",
              url: rea_ajax_select2_localize.ajaxurl + "?action=rea_ajax_select2_get_title",
              data: {
              ...
              if (response.success && "undefined" !== typeof response.data.results) {
                ...
                ids.forEach(function (item, index) {
                  if ("undefined" !== typeof response.data.results[item]) {
                    var key = item;
                    var value = response.data.results[item];
                    options += "<option selected=\"selected\" value=\"".concat(key, "\">").concat(value, "</option>");
                  }
                });
      ...
      }, 200); //Manual Sorting : Select2 drag and drop : ends
    }, 100);
  });
})(jQuery);
...
module.exports = __webpack_require__(16).Array.isArray;
...
/***/ })
/******/ ]);
//# sourceMappingURL=rea-ajax-select2.js.map