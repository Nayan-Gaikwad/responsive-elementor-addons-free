...
(function ($, window, document, undefined) {
  ...
  var pluginName = 'reaVisualSelect',
      defaults = {
    item: 'rea-select-item',
    // visual select item [class name]
    selected: 'rea-selected',
    // selected item [class name]
    caption: 'rea-select-caption',
    // caption under visual item [class name]
    container: 'rea-visual-select',
  ...
  function Plugin(element, options) {
    ...
    this.$element = $(element);
    this.options = $.extend({}, defaults, options); // read attributes
  ...
  $.extend(Plugin.prototype, {
     ...
     */
    _generateVideoSource: function _generateVideoSource(videoSrc) {
      var source = '';
     ...
     */
    _videoInit: function _videoInit(event) {
     ...
     * @public
     */
    generate: function generate(reset) {
      var self = this,
          st = self.options;
...
/***/ })
/******/ ]);
//# sourceMappingURL=visual-select.js.map