...
namespace Responsive_Elementor_Addons\WidgetsManager\Modules\SingleQueryControl;

use Elementor\Plugin;
use Responsive_Elementor_Addons\WidgetsManager\Modules\QueryControl\Module as QueryControlModule;
use Elementor\TemplateLibrary\Source_Local;
/**
 * Module Class extending Query Control Module.
 *
 * @since 1.0.0
 */
class Module extends QueryControlModule
{
    const QUERY_CONTROL_ID        = 'rea-single-query';
    ...
    /**
     * Function autocomplete query for post
     *
    ...
    /**
     * Function autocomplete query for library template
     *
     * @param  array $data Data.
     * @return array
     */
    ...
    /**
     * Function autocomplete query for attachment
     *
     * @param  array $data Data.
     * @return array
     */
    ...
    /**
     * Function autocomplete query for text
     *
     * @param  array $data Data.
     * @return array
     */
    ...
    /**
     * Function autocomplete query for author
     *
     * @param  array $data Data.
     * @return array
     */
    ...
    /**
     * Function autocomplete query for user
     *
     * @param  array $data Data.
     * @return array
     */
    ...
    /**
     * Function Get titles query for post
     *
     * @param  array $data Data.
     * @return array
     */
    ...
    /**
     * Function Get titles query for attachment
     *
     * @param  array $data Data.
     * @return array
     */
    ...
    /**
     * Function Get titles query for taxonomy
     *
     * @param  array $data Data.
     * @return array
     */
    ...
    /**
     * Function Get titles query for library template
     *
     * @param  array $data Data.
     * @return array
     */
    ...
    /**
     * Function Get titles query for author
     *
     * @param  array $data Data.
     * @return array
     */
    ...
    /**
     * Function Get titles query for user
     *
     * @param  array $data Data.
     * @return array
     */
    ...
    private function get_term_name( $term, $display, $request, $filter_name = 'get_autocomplete' )
    {
        ...
        case 'minimal':
            ...
            break;
        default:
            $text = apply_filters("rea/core_elements/single_query_control/{$filter_name}/display/{$display}", $term_name, $request);
            break;
        }
        return $text;
    }
    ...
    /**
     * Function Format post for display
     *
     * @param  mixed  $post        Post.
     * @param  mixed  $display     Display.
    ...
    private function format_post_for_display( $post, $display, $data, $filter_name = 'get_autocomplete' )
    {
        ...
        case 'detailed':
            ...
            break;
        default:
            $text = apply_filters("rea/core_elements/single_query_control/{$filter_name}/display/{$display}", $post->post_title, $post->ID, $data);
            break;
        }
    ...
    private function format_user_for_display( $user, $display, $data, $filter_name = 'get_autocomplete' )
    {
        ...
        case 'detailed':
            ...
            break;
        default:
            $text = apply_filters("rea/core_elements/single_query_control/{$filter_name}/display/{$display}", $user, $data);
            break;
        }
    ...
    /**
     * Function Get titles query data
     *
     * @param  array $data Data.
     * @return array
     */
    ...
    /**
     * Function Ajax Posts Control Value Titles
     *
    ...
    public function ajax_posts_control_value_titles( $request )
    {
        ...
        case self::QUERY_OBJECT_TAX:
            ...
            foreach ( $terms as $term ) {
                if (apply_filters("rea/core_elements/single_query_control/get_value_titles/tax/{$display}", true, $term, $request) ) {
        ...
        case self::QUERY_OBJECT_POST:
            ...
            foreach ( $query->posts as $post ) {
                if (apply_filters("rea/core_elements/single_query_control/get_value_titles/custom/{$display}", true, $post, $request) ) {
        ...
        case self::QUERY_OBJECT_USER:
            ...
            foreach ( $user_query->get_results() as $user ) {
                if (apply_filters("rea/core_elements/single_query_control/get_value_titles/user/{$display}", true, $user, $request) ) {
                    $results[ $user->ID ] = $this->format_user_for_display($user, $display, $request, 'get_value_titles');
                }
            }
            break;
        default:
            $results = apply_filters("rea/core_elements/single_query_control/get_value_titles/{$query_data['filter_type']}", $results, $request);
        }
    ...
    /**
     * Function Ajax Posts Filter Autocomplete.
     *
     * @param  array $data Data.
    ...
    public function ajax_posts_filter_autocomplete( array $data )
    {
        ...
        case self::QUERY_OBJECT_TAX:
            ...
            foreach ( $terms as $term ) {
                if (apply_filters("rea/core_elements/single_query_control/get_autocomplete/tax/{$display}", true, $term, $data) ) {
                    $results[] = array(
                    'id'   => $term->{$by_field},
        ...
        case self::QUERY_OBJECT_POST:
            ...
            foreach ( $query->posts as $post ) {
                if (apply_filters("rea/core_elements/single_query_control/get_autocomplete/custom/{$display}", true, $post, $data) ) {
        ...
        case self::QUERY_OBJECT_AUTHOR:
            ...
            foreach ( $user_query->get_results() as $user ) {
                if (apply_filters("rea/core_elements/single_query_control/get_autocomplete/user/{$display}", true, $user, $data) ) {
                    $results[] = array(
                    'id'   => $user->ID,
            ...
            break;
        default:
            $results = apply_filters('rea/core_elements/single_query_control/get_autocomplete/' . $query_data['filter_type'], $results, $data);
        }
    ...
    /**
     * Register REA Single Query Controls
     *
     * @return void
     */
    public function register_rea_single_query_controls()
    {
        $controls_manager = Plugin::instance()->controls_manager;

        $controls = array(
        'rea-single-query' => array(
    ...
    /**
     * Function Register Ajax REA Single Query Actions.
     *
     * @param  [type] $ajax_manager Ajax Manager.
     * @return void
     */
    public function register_ajax_rea_single_query_actions( $ajax_manager )
    {
        $ajax_manager->register_ajax_action('rea_single_query_control_value_titles', array( $this, 'ajax_posts_control_value_titles' ));
        $ajax_manager->register_ajax_action('rea_single_query_panel_posts_control_filter_autocomplete', array( $this, 'ajax_posts_filter_autocomplete' ));
    }
    ...
    {
        add_action('elementor/ajax/register_actions', array( $this, 'register_ajax_rea_single_query_actions' ));
        add_action('elementor/controls/controls_registered', array( $this, 'register_rea_single_query_controls' ));
