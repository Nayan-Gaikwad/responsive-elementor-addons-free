...
/**
 * Elementor Related Query Class extending Elementor Post Query
 *
 * @since   1.0.0
 * @package Responsive_Elementor_Addons
 */
class Elementor_Related_Query extends Elementor_Post_Query
{
    ...
    /**
     * Function Get Fallback Query
     *
     * @param  [type] $original_query Orifinal Query.
     * @return object
     */
    ...
    /**
     * Function to if fallback is valid
     *
     * @return bool
     */
    ...
    /**
     * Function Set Post Exclude Arguments
     *
     * @return void
     */
    ...
    /**
     * Function build terms query include
     *
    ...
    /**
     * Function to set fallback arguments by settings
     *
